...
public class Playerwhip
{
    ...
    public void playercheckforhook()
    {
        ...
        {
            hooktargetupdate();
            if (psm.checkcontroller(psm.controls.Player.Whip.WasPerformedThisFrame(), Input.GetButtonDown("Whip"), psm.controls.Player.Controllerwhip.WasPerformedThisFrame()) == true)
